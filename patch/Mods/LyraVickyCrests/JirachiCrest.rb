...
class PokeBattle_Move_111 #f sight, doomdesire
  alias rachicrest_pbEffectTarget pbEffectTarget if !defined?(rachicrest_pbEffectTarget)
...
class PokeBattle_Battle
  alias rachicrest_pbCrestEntry pbCrestEntry if !defined?(rachicrest_pbCrestEntry)
  ...
  alias rachicrest_pbLifeBlood pbLifeBlood if !defined?(rachicrest_pbLifeBlood)
