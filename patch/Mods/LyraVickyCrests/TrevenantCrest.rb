...
class PokeBattle_Battle
    alias_method :trevcrest_pbCrestEntry, :pbCrestEntry if !method_defined?(:trevcrest_pbCrestEntry)
...
class PokeBattle_Move_143 < PokeBattle_Move
  alias_method :trevcrest_pbEffectValid, :pbEffectValid if !method_defined?(:trevcrest_pbEffectValid)
  ...
  alias_method :trevcrest_pbEffectTarget, :pbEffectTarget if !method_defined?(:trevcrest_pbEffectTarget)
