...
class PokeBattle_Battler
    ...
    #item stuff
    alias atalescrest_hasWorkingItem hasWorkingItem if !defined?(atalescrest_hasWorkingItem)
    ...
    #curse effect
    alias atalescrest_pbEffectsOnDealingDamage pbEffectsOnDealingDamage if !defined?(atalescrest_pbEffectsOnDealingDamage)
...
class PokeBattle_Move
  ...
  alias atalescrest_pbModifySTAB pbModifySTAB if !defined?(atalescrest_pbModifySTAB)
  ...
  alias atalescrest_irregularTypeMods irregularTypeMods if !defined?(atalescrest_irregularTypeMods)
