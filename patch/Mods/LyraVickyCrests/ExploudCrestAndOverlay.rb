...
#   alias_method :expcrest_pbEffectTarget, :pbEffectTarget if !method_defined?(:expcrest_pbEffectTarget)
...
#   alias_method :expcrest_pbEffect, :pbEffect if !method_defined?(:expcrest_pbEffect)
...
class PokeBattle_Battler
  alias_method :expcrest_pbCanSleep?, :pbCanSleep? if !method_defined?(:expcrest_pbCanSleep?)
  ...
  alias_method :expcrest_pbAbilitiesOnOverlay, :pbAbilitiesOnOverlay if !method_defined?(:expcrest_pbAbilitiesOnOverlay)
...
class PokeBattle_Battle
    alias_method :expcrest_pbOnActiveOne, :pbOnActiveOne if !method_defined?(:expcrest_pbOnActiveOne)
    ...
    alias_method :expcrest_pbCrestEntry, :pbCrestEntry if !method_defined?(:expcrest_pbCrestEntry)
    ...
    alias_method :expcrest_reduceField, :reduceField if !method_defined?(:expcrest_reduceField)
    ...
    alias_method :expcrest_pbEndOfRoundPhase, :pbEndOfRoundPhase if !method_defined?(:expcrest_pbEndOfRoundPhase)
