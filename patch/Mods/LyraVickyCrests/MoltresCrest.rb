...
class PokeBattle_Battler
    ...
    alias_method :molcrest_hasCrest?, :hasCrest? if !method_defined?(:molcrest_hasCrest?)
...
class PokeBattle_Move
  alias_method :molcrest_irregularTypeMods, :irregularTypeMods if !method_defined?(:molcrest_irregularTypeMods)
...
class PokeBattle_Battle
    alias_method :molcrest_pbCrestEntry, :pbCrestEntry if !method_defined?(:molcrest_pbCrestEntry)
